 ...
 */
final class Version20200303191744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card CHANGE category_id category_id INT NOT NULL');
    }
}
